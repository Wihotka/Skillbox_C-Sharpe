    ...
    class Program
    {
        static void Main(string[] args)
        {
            ...
            while (true) 
            {
                ...
                Console.WriteLine("Введите число от 1 до 4"); // Получаем число первого игрока
                Console.Write($"Ход {playerOne}: ");
                number = int.Parse(Console.ReadLine());

                if ((number >= 1) && (number <= 4)) // Работаем с числом первого игрока
                {
                    randomNumber -= number;
                    Console.WriteLine("\n");
                }
                ...
                Console.WriteLine("Введите число от 1 до 4"); // Получаем число второго игрока
                Console.Write($"Ход {playerTwo}: ");
                number = int.Parse(Console.ReadLine());

                if ((number >= 1) && (number <= 4)) // Работаем с числом второго игрока
                {
                    randomNumber -= number;
                    Console.WriteLine("\n");
                }
